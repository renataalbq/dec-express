      ...
      <section>
        <div className="flex space-x-4 mt-4">
            <div className="w-64 h-52 shadow-md p-2 bg-white rounded-lg flex flex-col">
              ...
              <div className="mt-8">
                <span className="text-slate-500 text-4xl font-semibold">
                156
                </span>
               </div>
            </div>
            ...
            <div className="mt-4">
                <div>
                    <div className="flex justify-between">
                        <p>7º ano Fundamental II</p>
                        <p>8º ano Fundamental II</p>
                        <p>9º ano Fundamental II</p>
                        <p>1º ano Ensino Médio</p>
                        <p>2º ano Ensino Médio</p>
                    </div>
                    <div className="flex justify-between">
                        <p>25</p>
                        <p>20</p>
