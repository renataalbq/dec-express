const StudentHome = () => (
  <div>
        ...
        <div className="relative">
          <div className="w-70 h-56 shadow-md p-2 bg-white rounded-lg">
            ...
            <span className="text-slate-500">
              ...
              finibus neque eget fermentum cursus. Sed rhoncus mattis vehicula.
              Sed ac era.
            </span>
          </div>
    ...
    <section className="mt-8">
      <h2 className="text-2xl font-semibold">Sobre o DecExpress</h2>
      <div className="bg-white rounded shadow-md p-4 mt-4">
        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum id
          justo vel libero congue venenatis. Nunc non justo tincidunt, bibendum
          eros et, scelerisque libero. Fusce a justo vitae arcu scelerisque
          fermentum.
        </p>
      </div>
    </section>
    ...
    <section className="mt-8">
      ...
      <div className="bg-white rounded shadow-md p-4  mt-4">
        <p>
          Para entrar em contato com os administradores do sistema, entre em
          contato com os coordenadores e diretores da escola nos seguintes
          endereços de e-mail:
          <br />
          - Coordenação: coordenacao@escola.com
          <br />- Direção: direcao@escola.com
        </p>
      </div>
    </section>
  </div>
